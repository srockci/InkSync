...
#ifndef INKSYNC_SWIFT_H
#define INKSYNC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InkSync",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7InkSync11AppDelegate")
...
@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC7InkSync26OnboardingWindowController")
...
SWIFT_CLASS("_TtC7InkSync24SettingsWindowController")
...
SWIFT_CLASS("_TtC7InkSync23SyncLogWindowController")
